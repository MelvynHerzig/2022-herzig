...
int main(int argc, char *argv[])
{
    ...
    const QString baseName = "./debug/tucuxi-tuberxpert_en_US";
    if(!translator.load(baseName)) {
        std::cout << "Failed loading translation file" << std::endl;
    }
...
//    }
    ...
    std::cout << QTranslator::tr("welcome").toStdString() << std::endl;
