...
public:
    ...
    Status importFromFile(std::unique_ptr<XpertQuery::XpertQueryData>& _query, const std::string& _fileName);
    ...
    /// \return Result::Ok if the import went well, another Result else.
    Status importFromString(std::unique_ptr<XpertQuery::XpertQueryData>& _query, const std::string& _xml);
...
protected:
    ...
    /// \return Result::Ok if the import went well, another Result else.
    Status importDocument(std::unique_ptr<XpertQuery::XpertQueryData>& _query, Tucuxi::Common::XmlDocument& _document);
    ...
    std::unique_ptr<Query::AdministrativeData> createAdministrativeData(Common::XmlDocument& _document);
    ...
    std::unique_ptr<Query::Person> createPerson(Common::XmlNodeIterator& _personRootIterator);
    ...
    std::unique_ptr<Query::PersonalContact> createPersonalContact(Common::XmlNodeIterator& _personalContactRootIterator);
    ...
    std::unique_ptr<Query::InstituteContact> createInstituteContact(Common::XmlNodeIterator& _instituteContactRootIterator);
    ...
    std::unique_ptr<Query::Address> createAddress(Common::XmlNodeIterator& _addressRootIterator);
    ...
    std::unique_ptr<Query::Phone> createPhone(Common::XmlNodeIterator& _phoneRootIterator);
    ...
    std::unique_ptr<Query::Email> createEmail(Common::XmlNodeIterator& _emailRootIterator);
    ...
    std::unique_ptr<Query::ClinicalData> createClinicalData(Common::XmlNodeIterator& _clinicalDataRootIterator);
